  ...
  return (
    <Navbar bg="light">
      <Container className='fw-bold text-center'>
        ...
        <Nav.Link href="/addCasePage1"><BookmarkCheck className='fs-3 m-1' /><br />Add new case</Nav.Link>
        ...
        <Nav.Link href="/system"><Gear className='fs-3 m-1' /><br />System Maintenance</Nav.Link>
