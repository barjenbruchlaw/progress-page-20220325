            ...
            <main className='page-main py-5'>
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <Col>
                            <a href='/addUDCasePage9' className='btn btn-dark mx-5 px-5'>Back</a><a href='/addUDCasePage11' className='btn btn-dark mx-5 px-5'>Next</a>
...
export default AddUDCasePage10