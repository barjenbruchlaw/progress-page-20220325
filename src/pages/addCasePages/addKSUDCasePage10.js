            ...
            <main className='page-main py-5'>
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <Col>
                            <a href='/addKSUDCasePage9' className='btn btn-dark mx-5 px-5'>Back</a><a href='/addKSUDCasePage11' className='btn btn-dark mx-5 px-5'>Next</a>
...
export default AddKSUDCasePage10