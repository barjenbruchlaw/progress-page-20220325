    ...
    <main className='page-main py-5'>
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <Col>
                            <a href='/addKSRPCasePage6' className='btn btn-dark mx-5 px-5'>Back</a><a href='/addKSRPCasePage8' className='btn btn-dark mx-5 px-5'>Next</a>
...
export default AddKSRPCasePage7