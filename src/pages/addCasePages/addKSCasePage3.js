    ...
    <main className='page-main py-5'>
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <Col>
                            <a href='/addCasePage2' className='btn btn-dark mx-5 px-5'>Back</a><a href={RPUD === 'RP' ? '/addKSRPCasePage4' : '/addKSUDCasePage4'} className='btn btn-dark mx-5 px-5'>Next</a>
